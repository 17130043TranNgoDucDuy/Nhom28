                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="ltn__top-bar-menu">
                                <ul>
                                    <li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i class="fa fa-envelope-o" aria-hidden="true"></i> info@webmail.com</a></li>
                                    ...
                                    <div class="ltn__shop-details-img-gallery">
                                        <div class="ltn__shop-details-large-img">
                                            <div class="single-large-img">
                                                <a href="../img/resources/16.png" data-rel="lightcase:myCollection">
                                                    <img src="../img/resources/16.png" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                                <a href="../img/resources/16.png" data-rel="lightcase:myCollection">
                                            ...
                                            <div class="single-large-img">
                                                <a href="../img/product-page/17.png" data-rel="lightcase:myCollection">
                                                    <img src="../img/product-page/17.png" alt="Image">
                                                </a>
                                            </div>
                                            <div class="single-large-img">
                                            ...
                                            <div class="single-large-img">
                                                <a href="../img/product-page/7.png" data-rel="lightcase:myCollection">
                                                    <img src="../img/product-page/7.png" alt="Image">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="ltn__shop-details-small-img slick-arrow-2">
                                            ...
                                            <div class="single-small-img">
                                                <img src="../img/product-page/10.png" alt="Image">
                                            </div>
                                            <div class="single-small-img">
                                                <img src="img/product/6.png" alt="Image">
                                            </div>
                    ...
                    <div class="col-lg-4">
                        <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar">
                                    ...
                                    <li>
                                        <div class="top-rated-product-item clearfix">
                                            <div class="top-rated-product-img">
                                                <a href="product-details.html"><img src="../img/resources/16.png" alt="#"></a>
                                            </div>
                            ...
                            <div class="widget ltn__banner-widget">
                                <a href="shop.html"><img src="../img/resources/12.jpg" alt="#"></a>
                            </div>
                        </aside>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row ltn__related-product-slider-one-active slick-arrow-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="../img/product-page/7.png" alt="#"></a>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="../img/product-page/8.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                                    </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="../img/product-page/9.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                                    </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="../img/product-page/10.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                                    </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="../img/product-page/5.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge">New</li>
                                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg position-relative text-center---">
                            ...
                            <div class="btn-wrapper">
                                <a class="btn btn-effect-3 btn-white" href="shop.html">Explore Products <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                             ...
                             <div class="ltn__quick-view-modal-inner">
                                 <div class="modal-product-item">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="modal-product-img">
                                                <img src="../img/product-page/7.png" alt="#">
                                            </div>
                                             <div class="modal-product-info">
                                                <h5><a href="product-details.html">Digital Stethoscope</a></h5>

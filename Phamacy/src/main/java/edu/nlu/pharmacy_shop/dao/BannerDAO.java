...
public class BannerDAO implements Serializable {
	...
	public List<Banner> findAll(String keyword, String sortField, String sortType, int pageSize, int index) {
		...
		String sql = "SELECT id, image_path, name, created_time, enabled FROM banners WHERE name LIKE ? " + "ORDER BY "
				+ sortField + " " + sortType + " LIMIT ? OFFSET ?";
	 ...
	 * @return Banner entity if the banner entity with the given id exists, null
	 *         otherwise.
	 */
	 ...
	 * @return Banner entity if the banner entity with the given image path exists,
	 *         null otherwise.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(d.findByImagePath("122.jpg").toString());
	}
}
